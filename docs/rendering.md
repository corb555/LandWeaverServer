...
1.  **Sources**: The  input georeferenced rasters (DEM, Slope, Land Cover).
...
*   **How it works:** By adjusting the `Jitter` and `Noise ID` settings, the noise  pushes the boundary (like a snowline 
